...
\begin{frame}{}
	...
	\begin{block}{Um pouco de História}
		...
		Esta biblioteca foi desenvolvida em (informar data) sob a supervisão do professor Antonio Castelo Filho e \textbf{CIA}, com financiamento da Petrobras. O projeto contou com a colaboração de mais de dez alunos de pós-graduação, que contribuíram para seu aprimoramento e aplicação em diversas pesquisas, resultando na publicação de inúmeros artigos científicos, como  (\citeauthoronline{Sousa2019}), \citeauthoronline{CastilloSanchez2023}) e dissertações como (\citeauthoronline{raymundo}).
	\end{block}
\end{frame}
