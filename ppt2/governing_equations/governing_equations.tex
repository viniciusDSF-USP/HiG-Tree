...
\begin{frame}{Equações Governantes - Conservação da Massa}
...
\begin{frame}{Equações Governantes - Balanço de Momentum Linear}
...
\begin{frame}{Equações Governantes - Forma Adimensional}
