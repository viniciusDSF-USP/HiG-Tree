...
hig_cell *higflow_make_adapted_tree_params(
  ...
  \begin{itemize}
    ...
    \item \textbf{thresholds[]}: Array contendo os limiares de distância para cada nível de refinamento.
    \item \textbf{Retorno}: Raiz da nova árvore HiG com a malha adaptada.
  \end{itemize}
\end{frame}
...
for (int l = num_levels - 1; l >= 0; l--) {
  ...
  \begin{itemize}
    ...
    \item Exemplo: \textit{thresholds[0]} (0.05) para Nível 1; \textit{thresholds[1]} (0.03) para Nível 2.
  \end{itemize}
\end{frame}
